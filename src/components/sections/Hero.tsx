  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center text-center">
      ...
      <div className="relative z-10 max-w-3xl animate-fade-up">
        ...
        <h1 className="font-mono text-6xl md:text-7xl font-bold text-white mb-5 tracking-tight leading-none">Trevor Danahy</h1>

        <p className="font-mono text-lg md:text-xl text-[#38BDF8] mb-3 tracking-wide">
          Software Engineer → Controls, Automation, &amp; Industry 4.0
        </p>
        <p className="text-slate-400 text-base leading-relaxed max-w-xl mx-auto mb-10">
          I build software, learn industrial control systems,
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-14">
          <Link
            to="/projects"
            className="group font-mono text-sm px-7 py-3 bg-[#38BDF8] text-[#0C1016] font-semibold hover:bg-[#7DD3FC] transition-colors flex items-center gap-2"
          >
            View Projects
          ...
          <a
            href="#contact"
            className="font-mono text-sm px-7 py-3 border border-[#38BDF8]/35 text-[#38BDF8] hover:bg-[#38BDF8]/10 transition-colors"
          >
            Resume PDF
          </a>
          <a
            href="#contact"
            className="font-mono text-sm px-7 py-3 border border-slate-700 text-slate-400 hover:border-slate-500 hover:text-slate-200 transition-colors"
          >
            LinkedIn
          </a>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {stats.map((s) => (
            <div
              key={s.label}
              className="border border-[#38BDF8]/15 bg-[#1A1F26]/65 backdrop-blur-sm px-5 py-3.5 text-left hover:border-[#38BDF8]/30 transition-colors"
            >
